...
const curriculum = [
  ...
  "Spring Bean Lifecycle & Configuration",
  "Aspect Oriented Programming (AOP)",
  "Spring JDBC & Hibernate Integration",
...
export default function SpringPage() {
  return (
    <>
      <SEO
        title="Spring Framework Training"
        description="Learn Dependency Injection, Aspect-Oriented Programming (AOP), MVC web apps, and Database Integration in Spring Framework."
      />
          ...
          <div className="container mx-auto px-6">
            <div className="grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                "
                >
                  Master Dependency Injection, inversion of control (IoC), Spring MVC, aspect-oriented programming (AOP), and enterprise integration patterns.
                </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">1500+</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
