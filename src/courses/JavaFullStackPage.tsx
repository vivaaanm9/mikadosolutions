  ...
  return (
    <>
      <SEO
        ...
        description="Master Java Full Stack Development with Spring Boot, React and Microservices."
      />
          ...
          <div className="container mx-auto px-6">
            <div className="grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                "
                >
                  Become a complete Full Stack Developer with Java, Spring Boot, Microservices, React, Docker, and AWS. Master backend development, frontend components, and modern cloud deployment techniques.
                </p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">6 Months</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">Beginner to Advanced</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">2500+</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
