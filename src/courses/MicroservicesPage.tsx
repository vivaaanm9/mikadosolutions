...
const curriculum = [
  "Microservices Fundamentals & Patterns",
...
export default function MicroservicesPage() {
  return (
    <>
      <SEO
        title="Microservices Architecture Training"
        description="Master distributed systems, Service Discovery (Eureka), API Gateway routing, Kafka event streaming, Docker containers, and cloud native architectures."
      />
          ...
          <div className="container mx-auto px-6">
            <div className="grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                "
                >
                  Learn distributed systems, API Gateway, Service Discovery, Docker, Kafka, and Cloud Native architecture to build highly resilient and scalable backend applications.
                </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">Advanced</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">1200+</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
