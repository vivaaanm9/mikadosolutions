...
const curriculum = [
  ...
  "Database Operations with SQLite/MySQL",
  ...
  return (
    <>
      <SEO
        ...
        description="Learn Python programming, web development with Flask/FastAPI, automation, data handling, and backend integrations."
      />
          ...
          <div className="container mx-auto px-6">
            <div className="grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                "
                >
                  Learn Python programming, automation, backend web development with FastAPI and Flask, scripting, and database integrations.
                </p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">4 Months</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">1800+</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
