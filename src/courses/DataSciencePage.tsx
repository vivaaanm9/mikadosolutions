  ...
  return (
    <>
      <SEO
        ...
        description="Learn Data Analytics with Python, Pandas, NumPy, Machine Learning algorithms, Data Visualization, and Artificial Intelligence fundamentals."
      />
          ...
          <div className="container mx-auto px-6">
            <div className="grid gap-12 lg:grid-cols-12 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                "
                >
                  Master data analysis, data visualization, statistical programming, and machine learning models with Python, Pandas, NumPy, and Scikit-Learn.
                </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-slate-800">1000+</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="rounded-xl bg-blue-50 p-3 text-blue-600">
